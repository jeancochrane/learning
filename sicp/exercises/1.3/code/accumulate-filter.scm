...
(define (sum-of-prime-squares a b)
  ;; Sum the squares of the prime series using `accumulate-filter`
  (define (filter n) (prime? n))
  (define (combiner a b) (+ a b))
  (define null-value 0)
  (define (term n) (* n n))
  (define (next n) (+ 1 n))
  (accumulate-filter combiner null-value filter term a next b))
...
(define (product-of-primes n)
  ...
  (define (term a) a)
  (define (next a) (+ 1 a))
  (accumulate-filter combiner null-value filter term 1 next n))
